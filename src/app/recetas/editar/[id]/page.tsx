...
const RecipeUpdate = ({ params }: { params: { id: string } }) => {
    ...
    useEffect(() => {
      const fetchRecipe = async () => {
        axios.get(`http://localhost:3000/api/recipes/${params.id}`)
        .then((res) => {
  ...
  return (
    <div className="mb-20 sm:mb-0">
      <form onSubmit={(event) => onSubmit(event)}  className="flex flex-col rounded-md gap-10 bg-green-100 w-[370px] sm:w-[500px] p-5 m-auto mt-10">
        <h1 className="text-3xl m-auto">Editar Receta </h1>
        ...
        <div className='self-center'>
          ...
          <textarea name="description" id="description" cols={30} rows={10} maxLength={300} placeholder={recipe.description} 
        ...
        <div className="self-center w-[250px] sm:w-[350px] h-fit">
          ...
          <textarea name="ingredients" id="ingredients" cols={30} rows={30} maxLength={300} placeholder={recipe.ingredients} 
        ...
        <div className="self-center w-[250px] sm:w-[350px] h-fit">
          ...
          <textarea name="pasos" id="pasos" cols={30} rows={30} maxLength={300} placeholder={recipe.pasos} 
