...
export function GoIcon({ title }: { title: string }) {
  return (
...
export function MenuIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-[80px] h-[80px]">
...
export function FilledStar() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="#f6e445" viewBox="0 0 24 24" strokeWidth={1} stroke="#333333" className="w-full h-full">
...
export function DeleteReportIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
      <title>Borrar Reporte</title>
...
export function ResetIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
      <title>Reestablecer Receta</title>
...
export function ConfirmScheduleIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
      <title>Agendar</title>
      <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 6 6 9-13.5" />
...
export function UnBanIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
      <title>Desbanear Usuario</title>
